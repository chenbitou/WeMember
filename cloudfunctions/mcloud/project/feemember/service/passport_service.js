...
const validate = require('../../../framework/validate/data_check.js');
...
class PassportService extends BaseProjectService {
	...
	async register(userId, {
		...
		if (cnt > 0) this.AppError('该手机已经被使用');
	...
	async getMyDetail(userId) {
		...
		let fields = 'USER_VIP_DAY,USER_VIP_START_DAY,USER_MOBILE,USER_NAME,USER_FORMS,USER_OBJ,USER_STATUS,USER_CHECK_REASON,USER_PAY_STATUS'
	...
	async login(userId) {
		...
		let fields = 'USER_ID,USER_MINI_OPENID,USER_NAME,USER_STATUS,USER_OBJ';
